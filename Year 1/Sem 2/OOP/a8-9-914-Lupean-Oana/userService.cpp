...
void UserService::repositoryType(const std::string &fileType) {
    if (fileType == "csv") {
        ...
        std::string userFile = R"(/Users/oanalupean/Downloads/a8-9-914-Lupean-Oana/Playlist.csv)";
        auto *repo = new CSVRepo{userVector, userFile};
        this->userRepository = repo;
    } else if (fileType == "html") {
        std::vector<Movie> userVector;
        std::string userFile = R"(/Users/oanalupean/Downloads/a8-9-914-Lupean-Oana/Playlist.html)";
